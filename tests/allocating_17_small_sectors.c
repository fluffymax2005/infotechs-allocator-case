...
int main() {
    ...
    void* s14 = allocator_alloc(allocator, SMALL_BLOCK_SIZE);
    void* s15 = allocator_alloc(allocator, SMALL_BLOCK_SIZE);
    void* s16 = allocator_alloc(allocator, SMALL_BLOCK_SIZE);
    void* s17 = allocator_alloc(allocator, SMALL_BLOCK_SIZE);
